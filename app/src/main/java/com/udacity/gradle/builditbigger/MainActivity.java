...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getJokeBtn = (Button) findViewById(R.id.btn_tell_joke);
    }
    ...
    public void tellJoke() {
        ...
        getJokeBtn.setVisibility(View.INVISIBLE);
        ...
        new GetJokeTask(new GetJokeTask.Listener() {
            ...
            public void onJokeLoaded(String joke) {
                if (joke.isEmpty()) {
                    ...
                    intent.putExtra(JokeViewerActivity.JOKE_EXTRA, joke);
                    startActivity(intent);
                }
                progressBar.setVisibility(View.INVISIBLE);
                getJokeBtn.setVisibility(View.VISIBLE);
            }
        }).execute();
    }
